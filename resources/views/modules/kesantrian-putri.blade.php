...
<div class="grid gap-6">
    <section class="bg-white dark:bg-gray-900 rounded-3xl border border-gray-200 dark:border-gray-800 p-6 shadow">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
                <h2 class="text-lg font-semibold text-gray-800 dark:text-gray-100">Ringkasan Layanan Kesehatan Santri Putri</h2>
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Data real-time dari modul kesehatan Filament.</p>
            </div>
            <div class="flex gap-3">
                <a href="{{ url('/filament/kesantrian-dashboard') }}" class="px-4 py-2 rounded-full bg-rose-500 text-white text-sm font-semibold shadow hover:bg-rose-600">Dashboard Kesantrian</a>
    ...
    <section class="bg-white dark:bg-gray-900 rounded-3xl border border-gray-200 dark:border-gray-800 p-6 shadow">
        <div class="flex items-center justify-between">
            ...
            <a href="{{ url('/filament/kesehatan/rekap') }}" class="text-sm font-semibold text-rose-600 hover:text-rose-700">Rekap Lengkap →</a>
        </div>
