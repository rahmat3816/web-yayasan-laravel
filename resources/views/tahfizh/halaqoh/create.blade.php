{{-- resources/views/tahfizh/halaqoh/create.blade.php --}}
@extends('layouts.app')
    ...
    <form action="{{ route('tahfizh.halaqoh.store') }}" method="POST" class="space-y-5">
        ...
        <div>
            ...
            <input type="text" name="nama_halaqoh" value="{{ old('nama_halaqoh') }}"
                ...
                placeholder="Contoh: Halaqoh Ustadz Ahmad"
                required>
        </div>
        ...
        <div>
            ...
            <p class="text-xs text-gray-500 mt-1">
                Hanya guru yang sesuai unit dan jenis kelamin yang ditampilkan.
            </p>
        </div>
        ...
        <div>
            ...
            <p class="text-xs text-gray-500 mt-1">
                Santri akan otomatis difilter berdasarkan <b>unit</b> dan <b>jenis kelamin guru</b>.
            </p>
        </div>
