...
<head>
    ...
    <title>{{ trim($__env->yieldContent('title', 'Panel Admin').' - ') }}{{ config('app.name', 'Yayasan As-Sunnah') }}</title>
...
<body class="min-h-screen bg-transparent">
    <div class="drawer lg:drawer-open min-h-screen">
        <input id="admin-drawer" type="checkbox" class="drawer-toggle" x-model="sidebarOpen">
            ...
            <nav class="sticky top-0 z-20 mx-4 md:mx-6 mt-4 glass-card border border-white/40 dark:border-slate-800/70 shadow-glass">
                <div class="h-16 px-4 md:px-6 flex items-center justify-between gap-4">
                    <div class="flex items-center gap-3">
                        <label for="admin-drawer" class="btn btn-circle btn-ghost btn-sm lg:hidden" aria-label="Toggle sidebar">
